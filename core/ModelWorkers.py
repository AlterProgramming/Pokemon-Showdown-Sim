...
def load_runtime_artifacts(repo_path: Path, model_entry: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "base_feature_dim": model_entry.get("base_feature_dim"),
        "sequence_model": bool(model_entry.get("sequence_model")),
        "sequence_length": model_entry.get("sequence_length"),
        "sequence_padding": model_entry.get("sequence_padding"),
