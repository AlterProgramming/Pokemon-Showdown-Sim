...
from EntityModelV1 import GLOBAL_NUMERIC_DIM, POKEMON_NUMERIC_DIM, build_entity_action_models
...
class EntityModelV1Tests(unittest.TestCase):
    def test_policy_only_entity_model_fits(self) -> None:
    ...
    def test_policy_transition_value_entity_model_fits(self) -> None:
        model, _, policy_value_model = build_entity_action_models(
            vocab_sizes={
                "species": 12,
                "item": 10,
                "ability": 10,
